class Main:
    #! Processo realizado pelo terminal!
    def telaInicial():
        op = int(
            input(
                """
    ...
    while True:
        ...
        match op:
            ...
            case 1:
                GerarArqRes = int(
                    input(
                        "Você deseja gerar um arquivo de texto com os dados e o resultado? 1-Sim 2-Não\n"
                    )
                )
                if GerarArqRes == 1:
                ...
                while i < quantMat:
                    ...
                    isConfirm = int(
                        input(
                            "Todas as informações acima estão corretas? 1-Sim 2-Não\n"
                        )
                    )
